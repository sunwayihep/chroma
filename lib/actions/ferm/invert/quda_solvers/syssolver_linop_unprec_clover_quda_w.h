...
#ifndef __syssolver_linop_quda_unprec_clover_h__
#define __syssolver_linop_quda_unprec_clover_h__
...
namespace LinOpSysSolverQUDAUnprecCloverEnv
{
...
class LinOpSysSolverQUDAUnprecClover : public LinOpSystemSolver<LatticeFermion>
{
public:
	 ...
	 */
	LinOpSysSolverQUDAUnprecClover(Handle< LinearOperator<T> > A_,
	...
	{
		QDPIO::cout << "LinOpSysSolverQUDAUnprecClover:" << std::endl;
...
#warning "USING QUDA DEVICE IFACE"
	...
	~LinOpSysSolverQUDAUnprecClover()
	{
